    ...
    <React.Fragment>
      ...
      <Container>
        ...
        <Row className="mt-5">   
          ...
          <Col lg={7} md={6} sm={12} className={`${classes.formContainer} p-5 m-auto mb-5 shadow-sm rounded-lg`}>
            <h1 className="p-3 text-center rounded" style={{ color: "#2c49ed" }}>Registration Form</h1>
            <Formik
